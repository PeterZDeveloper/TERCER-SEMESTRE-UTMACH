...
public class Algoritmos {
    ...
    /**
     * Genera un arreglo de n objetos tipo Persona con números de cédula aleatorios
     * de la provincia de El Oro y pesos entre 60 y 110 Kg.
     * 
     * @param n Cantidad de personas a generar
     * @return Arreglo de personas generadas
     */
    public static Persona[] generarPersonas(int n) {
        Persona[] personas = new Persona[n];

        for (int i = 0; i < n; i++) {
            String cedula = cedulaAleatorio("07");
            double peso = aleatorio(60, 110, 1);
            personas[i] = new Persona(cedula, peso);
        }
    ...
    /**
     * Genera una copia de un arreglo unidimensional.
     * 
     * @param a Arreglo a copiar
    ...
    /**
     * Muestra por pantalla un arreglo unidimensional.
     * 
